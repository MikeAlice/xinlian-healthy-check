...
list<PreviewReportDO> PreviewReportDAO::selectByName(const string& nameID) {
	...
	return sqlSession->executeQuery<PreviewReportDO, PreviewReportMapper>(sql, mapper, "%s", nameID);
}