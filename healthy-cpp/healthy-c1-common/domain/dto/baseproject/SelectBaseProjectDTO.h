...
/*
 ...
 @Author: firmiana
 @Date: 2024/01/23
 @FileName: SelectBaseProjectDTO.h
 @version: 1.0
...
class SelectBaseProjectDTO :public oatpp::DTO
{
	DTO_INIT(SelectBaseProjectDTO, DTO);
	// id 主键
...
class SelectBaseProjectPageDTO :public PageDTO<SelectBaseProjectDTO::Wrapper>
{
	DTO_INIT(SelectBaseProjectPageDTO, PageDTO<SelectBaseProjectDTO::Wrapper>);
};
