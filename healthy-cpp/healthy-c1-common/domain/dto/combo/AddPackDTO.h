...
#ifndef _ADDPACKDTO_H_
#define _ADDPACKDTO_H_

#include "../../GlobalInclude.h"

#include OATPP_CODEGEN_BEGIN(DTO)

class AddPackDTO : public oatpp::DTO
{
 ...
 * 定义一个用户信息分页传输对象
 */
class AddPackPageDTO : public PageDTO<AddPackDTO::Wrapper>
{
	DTO_INIT(AddPackPageDTO, PageDTO<AddPackDTO::Wrapper>);
};
